...
import com.example.rbpo2.license.config.LicenseKeyProperties;
...
public class TicketSignatureService {
    ...
    public TicketSignatureService(LicenseKeyProperties properties) {
        this.keystorePath = properties.getPath() != null ? properties.getPath() : "classpath:keystore.p12";
        this.keystorePassword = properties.getPassword() != null ? properties.getPassword() : "6semStepchenkovBKS2302";
        this.keyAlias = properties.getKeyAlias() != null ? properties.getKeyAlias() : "laba6_key";
    }
